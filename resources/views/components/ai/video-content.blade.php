@php
    $messages = [
        ...
        [
            ...
            'model_icon' => './images/model/google.svg',
            ...
            'video_thumb' => './images/ai/video-thumb.png',
            'video_url' => 'https://www.youtube.com/watch?v=_iHmNaQBtKk',
        ]
    ];
    ...
    $models = [
        [
            'name' => 'Google Veo 3.1',
            'type' => 'img',
            'src' => './images/model/google.svg',
            'alt' => 'google veo',
        ],
        [
            'name' => 'Kling 3.0 Pro',
            'type' => 'img',
            'src' => './images/model/kling.svg',
            'alt' => 'kling',
        ],
        [
            'name' => 'Seedream 5.0',
        ...
        [
            'name' => 'Runway 4.5',
            'type' => 'img-themed',
            'src_light' => './images/model/runway.svg',
            'src_dark' => './images/model/runway-dark.svg',
            'alt' => 'runway',
        ],
        [
            'name' => 'xAI Grok Video',
...
<div class="relative mx-auto flex max-w-[720px] flex-col">
    <div class="custom-scrollbar relative z-20 max-h-[50vh] space-y-7 overflow-y-auto pb-10 lg:max-h-[55vh] lg:pb-7">
                ...
                <div class="flex justify-start">
                    <div>
                        <div class="max-w-[480px]">
                            ...
                            <div class="group relative w-full max-w-[400px] overflow-hidden rounded-xl">
                                <img src="{{ $message['video_thumb'] }}"
                                    class="w-full rounded-xl border border-gray-100 object-cover dark:border-gray-700"
                                    alt="" />
                                <a href="{{ $message['video_url'] }}"
                                    class="video-popup absolute top-1/2 left-1/2 flex h-20 w-20 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-white/40 backdrop-blur-[10px]">
                                ...
                                <div
                                    class="absolute top-0 right-0 flex -translate-y-full items-center justify-between px-3 py-3 opacity-0 transition-all duration-300 ease-in-out group-hover:translate-y-0 group-hover:opacity-100">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <button data-tooltip="Regenerate" data-tooltip-placement="top"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                viewBox="0 0 16 16" fill="none">
                                                <path
                                                    d="M13.6351 6.49025C13.3028 5.24998 12.5705 4.15402 11.5518 3.37235C10.5331 2.59068 9.28494 2.16699 8.00091 2.16699C6.71688 2.16699 5.46873 2.59068 4.45004 3.37235C3.43136 4.15402 2.69906 5.24998 2.36673 6.49025C2.29896 6.74315 2.25575 6.92051 2.22989 7.04262M2.36492 9.50909C2.69725 10.7494 3.42955 11.8453 4.44823 12.627C5.46692 13.4087 6.71507 13.8324 7.9991 13.8324C9.28313 13.8324 10.5313 13.4087 11.55 12.627C12.5687 11.8453 13.301 10.7494 13.6333 9.50909C13.7024 9.25111 13.7463 9.07175 13.7724 8.94947M1.13614 5.0999L2.22989 7.04262L2.29256 7.15392L4.34636 5.99744M11.6602 10.0022L13.714 8.84571L13.7724 8.94947M14.8704 10.8997L13.7724 8.94947"
                                                    stroke="currentColor" stroke-width="1.2" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                            </svg>
                                        </button>
                                        ...
                                        <button data-tooltip="Download" data-tooltip-placement="top"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                                ...
                                                <path
                                                    d="M15.0003 12V13.875C15.0003 14.4963 14.4966 15 13.8753 15H4.12466C3.50334 15 2.99966 14.4963 2.99966 13.875V12M9.00115 12L9.00115 3M5.53094 8.53155L8.99957 11.998L12.4684 8.53155"
            ...
            <div class="flex items-center justify-between pt-2">
                <div class="flex gap-2">
                    ...
                    <div class="relative block sm:hidden" @click.away="open = false; activeMenu = null">
                        ...
                        <div x-show="open" x-cloak
                            ...
                            <div x-show="activeMenu === null">
                                ...
                                <button @click="activeMenu = 'duration'"
                                    class="flex w-full items-center justify-between gap-2 rounded-lg px-3.5 py-3 text-gray-800 hover:bg-gray-100 dark:text-white/90 dark:hover:bg-gray-800">
                                    <div class="flex items-center gap-2.5">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 20 20" fill="none">
                                            <path
                                                d="M13.3333 9.99935H9.99996L9.99986 5.41602M17.7083 9.99935C17.7083 14.2565 14.2572 17.7077 9.99996 17.7077C5.74276 17.7077 2.29163 14.2565 2.29163 9.99935C2.29163 5.74215 5.74276 2.29102 9.99996 2.29102C14.2572 2.29102 17.7083 5.74215 17.7083 9.99935Z"
                                                stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                        </svg>
                                    ...
                                    <div class="flex items-center gap-1">
                                        <span x-text="duration" class="text-sm"></span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            viewBox="0 0 16 16" fill="none">
                                            <path d="M5.91669 12.1663L10.0834 7.99967L5.91669 3.83301"
                                                stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                ...
                                <!-- Audio toggle row -->
                                <button @click="audioOn = !audioOn"
                                    class="flex w-full items-center justify-between gap-2 rounded-lg px-3.5 py-3 text-gray-800 hover:bg-gray-100 dark:text-white/90 dark:hover:bg-gray-800">
                                    <div class="flex items-center gap-2.5">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                            viewBox="0 0 20 20" fill="none" :class="audioOn ? '' : 'opacity-40'">
                                            <path x-show="audioOn"
                                                d="M14.2791 6.94598C15.7936 8.63275 15.7936 11.3675 14.2791 13.0543M12.5358 8.45962C13.3224 9.33437 13.3224 10.6659 12.5358 11.5407M8.33617 4.34943L5.49474 6.87515H3.54163C2.85127 6.87515 2.29163 7.4348 2.29163 8.12515V11.8752C2.29163 12.5655 2.85127 13.1252 3.54163 13.1252H5.49477L8.33617 15.6508C9.1423 16.3674 10.4166 15.7951 10.4166 14.7166V5.28369C10.4166 4.20513 9.1423 3.63288 8.33617 4.34943Z"
                                                stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                            <path x-show="!audioOn"
                                                d="M14.2791 6.94494C15.4156 8.21069 15.6993 10.0666 15.1301 11.6269M12.5358 8.45861C12.83 8.78578 13.0142 9.17685 13.0883 9.58402M2.29203 2.29102L6.22553 6.22451M6.22553 6.22451L10.4166 10.4156L17.7079 17.7069M6.22553 6.22451L5.49474 6.87411H3.54163C2.85127 6.87411 2.29163 7.43375 2.29163 8.12411V11.8741C2.29163 12.5645 2.85127 13.1241 3.54163 13.1241H5.49477L8.33617 15.6498C9.1423 16.3664 10.4166 15.7941 10.4166 14.7155V10.4156M8.07841 4.57751L8.33617 4.34839C9.1423 3.63183 10.4166 4.20409 10.4166 5.28265V6.91016"
                                                stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                        </svg>
                                        <span class="text-sm font-medium" x-text="audioOn ? 'Audio' : 'Muted'"></span>
                                    </div>
                                    <div class="flex items-center">
                                        <div :class="audioOn ? 'bg-brand-500' : 'bg-gray-200 dark:bg-gray-700'"
                                            class="relative inline-flex h-5 w-9 flex-shrink-0 cursor-pointer rounded-full transition-colors duration-200">
                                            <span :class="audioOn ? 'translate-x-4.5' : 'translate-x-0.5'"
                                                class="pointer-events-none inline-block h-4 w-4 translate-y-0.5 rounded-full bg-white shadow transition-transform duration-200"></span>
                                        </div>
                                    </div>
                                </button>
                            </div>
                            ...
                            <!-- Duration Sub-menu -->
                            <div x-show="activeMenu === 'duration'">
                                <div
                                    class="flex items-center gap-1.5 border-b border-gray-100 px-2 py-2 dark:border-gray-800">
                                    <button @click="activeMenu = null"
                                        class="flex items-center justify-center rounded-lg p-1.5 text-gray-500 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-800">
                                    ...
                                    <span class="text-sm font-medium text-gray-800 dark:text-white">Duration</span>
                                </div>
                                <ul class="space-y-0.5 p-1.5">
                                    @foreach ($durations as $d)
                                        <li>
                                            <button @click="duration = '{{ $d }}'; open = false; activeMenu = null"
                                                :class="duration === '{{ $d }}' ?
                                                    'bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white' :
                                                    'text-gray-700 dark:text-gray-400'"
                                                class="flex w-full items-center gap-2 rounded-lg px-2 py-2 text-sm hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-white">
                    ...
                    <div class="hidden gap-2 sm:flex">
                        ...
                        <div class="relative" @click.away="if (activeDropdown === 'resolution') activeDropdown = null">
                            <button data-tooltip="Resolution" data-tooltip-placement="top"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    viewBox="0 0 20 20" fill="none">
                                    <path
                                        d="M14.0339 3.33398H5.96601C5.5003 3.33398 5.0732 3.59288 4.85778 4.00578L3.09857 7.37759C2.86279 7.82963 2.92506 8.3796 3.2561 8.76738L9.99995 16.6673L16.7438 8.76738C17.0748 8.3796 17.1372 7.82963 16.9013 7.37759L15.1421 4.00578C14.9267 3.59288 14.4996 3.33398 14.0339 3.33398Z"
                                        stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M7.08337 7.28711L12.9167 7.28711" stroke="currentColor"
                                        stroke-width="1.5" stroke-linecap="round" />
                                </svg>
                        ...
                        <!-- Durations Dropdown -->
                        <div class="relative" @click.away="if (activeDropdown === 'duration') activeDropdown = null">
                            <button data-tooltip="Duration" data-tooltip-placement="top"
                                data-tooltip-variant="no-arrow" @click="activeDropdown = activeDropdown === 'duration' ? null : 'duration'" :aria-expanded="activeDropdown === 'duration'"
                                class="flex h-9 cursor-pointer items-center justify-center gap-1.5 rounded-lg border border-gray-200 py-2 pr-3 pl-2.5 text-sm text-gray-500 hover:text-gray-700 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-900 dark:hover:text-gray-300">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    viewBox="0 0 20 20" fill="none">
                                    <path
                            ...
                            <ul x-show="activeDropdown === 'duration'" x-transition.origin.bottom.left x-cloak role="menu"
                                class="shadow-theme-md absolute bottom-full left-0 mb-2 min-w-[86px] space-y-0.5 rounded-xl bg-white p-1.5 dark:bg-gray-900">
                                @foreach ($durations as $d)
                                    <li>
                                        <button @click="duration = '{{ $d }}'; activeDropdown = null"
                                            :class="duration === '{{ $d }}' ?
                                                'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-white' :
                                                'text-gray-700 dark:text-gray-400'"
                                            class="flex w-full items-center gap-2 rounded-lg px-1.5 py-2 text-sm hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-white"
                        ...
                        <!-- Audio -->
                        <div class="relative">
                            <button data-tooltip-placement="top" data-tooltip-variant="no-arrow"
                                :data-tooltip="audioOn ? 'Mute Audio' : 'Enable Audio'" @click="audioOn = !audioOn"
                                :class="audioOn ? 'border-gray-200 text-gray-700 dark:border-gray-700 dark:text-gray-300' :
                                    'border-gray-200 text-gray-400 dark:border-gray-700 dark:text-gray-600'"
                                class="flex h-9 cursor-pointer items-center justify-center gap-1.5 rounded-lg border py-2 pr-3 pl-2.5 text-sm hover:text-gray-700 dark:hover:bg-gray-900 dark:hover:text-gray-300">
                                <!-- Audio ON icon -->
                                <svg x-show="audioOn" xmlns="http://www.w3.org/2000/svg" width="20"
                                ...
                                <span x-text="audioOn ? 'Audio' : 'Muted'"></span>
                            </button>
                        </div>
                    </div>
                </div>
