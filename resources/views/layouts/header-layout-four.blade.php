<header
    ...
    class="sticky top-0 flex w-full border-gray-200 bg-white z-99999 dark:border-gray-800 dark:bg-gray-900 xl:border-b">
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <button
                class="hidden h-10 w-10 items-center justify-center rounded-lg border border-gray-200 text-gray-500 xl:flex dark:border-gray-800 dark:text-gray-400"
                @click.stop="$store.sidebar.toggleExpanded()"
                aria-label="Toggle Sidebar">
                <!-- Desktop: always-visible 16x12 hamburger (static CSS, no Alpine state) -->
                <svg
                ...
                <!-- Mobile: hamburger (sidebar closed) -->
                <svg
                    :class="$store.sidebar.isMobileOpen ? 'hidden' : 'block xl:hidden'"
            ...
            <!-- Mobile Sidebar Toggle Button (visible below xl) -->
            <button
                class="flex xl:hidden items-center justify-center w-10 h-10 text-gray-500 rounded-lg dark:text-gray-400 z-99999"
        ...
        <div :class="menuToggle ? 'flex' : 'hidden'"
            ...
            <div class="flex items-center gap-2 2xsm:gap-3 mx-auto xl:m-0">
                <!-- Theme Toggle Button -->
                <button
                ...
                <div>
                    <a href="#"
                        class="bg-brand-500 shadow-theme-xs hover:bg-brand-600 inline-flex items-center gap-2 rounded-lg px-4 py-3 text-sm font-medium text-white transition">
                        Get Started
                    </a>
                </div>
            </div>
