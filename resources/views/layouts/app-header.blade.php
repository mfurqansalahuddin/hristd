        ...
        <div :class="isApplicationMenuOpen ? 'flex' : 'hidden'"
            ...
            <div class="flex items-center gap-2 2xsm:gap-3">
                ...
                <button
                    ...
                    :aria-label="$store.theme.resolvedTheme === 'dark' ? 'Dark theme' : 'Light theme'"
                    @click="$store.theme.toggle()">
                    <svg x-show="$store.theme.resolvedTheme === 'dark'" class="hidden dark:block" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg x-show="$store.theme.resolvedTheme === 'light'" class="dark:hidden" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
