                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div>
                        <div class="mb-8 flex flex-col items-center text-center">
                            <img src="{{ asset('Logo%20TD%20nobg.png') }}" alt="Logo Perumdam Tirta Daroy"
                        ...
                        <div>
                            <form action="{{ route('signin.store') }}" method="POST">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <!-- Password -->
                                    <div>
                                        <x-form.input label="Kata Sandi" type="password" name="password"
            ...
            <div class="bg-brand-950 relative hidden h-full w-full items-center lg:grid lg:w-1/2 dark:bg-white/5">
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <img src="{{ asset('Logo%20TD%20nobg.png') }}" alt="Logo Perumdam Tirta Daroy"
                            class="mb-4 h-28 w-auto">
                        <p class="text-center text-lg font-semibold text-white">
                            PERUMDAM TIRTA DAROY
                        </p>
                        <p class="mt-1 text-center text-gray-400 dark:text-white/60">
                            Sistem Informasi SDM &amp; Penilaian Kinerja
                        </p>
                    </div>
                </div>
            </div>
