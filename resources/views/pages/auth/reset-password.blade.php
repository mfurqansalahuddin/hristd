            ...
            <div class="flex w-full flex-1 flex-col lg:w-1/2">
                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    ...
                    <div>
                        @if (session('status'))
                            <div
                                class="mb-4 rounded-lg bg-success-50 p-4 text-sm text-success-800 dark:bg-success-900/20 dark:text-success-400">
                                {{ session('status') }}
                            </div>
                        @endif
                        ...
                        <div class="mt-5">
                            <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                ...
                                <a href="{{ route('signin') }}" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Click
                                    here
                                </a>
                            </p>
                        </div>
