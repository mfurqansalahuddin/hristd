            ...
            <div class="mb-6 rounded-2xl border border-gray-200 p-5 lg:p-6 dark:border-gray-800">
                ...
                <div>
                    <div
                        ...
                        <div>
                            <span class="mb-1 block text-base font-medium text-gray-800 dark:text-white/90">Change
                                Password</span>
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <div
                        class="flex flex-col justify-between gap-4 border-b border-gray-200 py-4 first:pt-0 last:border-b-0 last:pb-0 sm:flex-row sm:items-end dark:border-gray-800">
                        <div>
                            <span class="mb-1 block text-base font-medium text-gray-800 dark:text-white/90">Two-factor
            ...
            <div class="mb-6 rounded-2xl border border-gray-200 p-5 lg:p-6 dark:border-gray-800">
                ...
                <div>
                    <div
                        class="flex flex-col justify-between gap-4 border-b border-gray-200 py-4 first:pt-0 last:border-b-0 last:pb-0 sm:flex-row sm:items-end dark:border-gray-800">
                        <div>
                            <span class="mb-1 block text-base font-medium text-gray-800 dark:text-white/90">Logout all
                                devices</span>
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <div
                        class="flex flex-col justify-between gap-4 border-b border-gray-200 py-4 first:pt-0 last:border-b-0 last:pb-0 sm:flex-row sm:items-end dark:border-gray-800">
                        <div>
                            <span class="mb-1 block text-base font-medium text-gray-800 dark:text-white/90">Delete
                                account</span>
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Sign out from every active session.
                            </p>
                    ...
                    <div>
                        ...
                        <div class="mb-6 flex max-w-sm items-center gap-6 lg:pr-5">
                            <div class="relative size-20 shrink-0 rounded-full sm:size-25">
                                <img src="{{ asset('images/user/owner.jpg') }}" alt="Profile Picture"
